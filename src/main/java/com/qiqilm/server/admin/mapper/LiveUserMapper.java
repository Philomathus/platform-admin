...
public interface LiveUserMapper {
    ...
    int updateLiveUserIsBanStopByFamilyId(@Param("id") Integer id,@Param("remark") String remark);
    int updateLiveUserIsBanKeepByFamilyId(@Param("id") Integer id,@Param("remark") String remark);
}
