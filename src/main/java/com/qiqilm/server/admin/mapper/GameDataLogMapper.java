...
public interface GameDataLogMapper {
	 ...
	 */
	@DataSource( value = "secondaryDataSource" )
	public List<GameDataLog> selectGameDataLogList( @Param( "cxAgent" ) String cxAgent, @Param( "start" ) String start,
													@Param( "end" ) String end, @Param( "account" ) String account,
													@Param( "platformId" ) String platformId );

	@DataSource( value = "secondaryDataSource" )
	public List<GameDataLog> selectGameDataAgentList( @Param( "tableNode" ) String tableNode, @Param( "start" ) String start,
													  @Param( "end" ) String end, @Param( "account" ) String account,
													  @Param( "platformId" ) String platformId );
