...
public class LiveUserWithdrawNewlogController extends BaseController {
	 ...
	 * 合并订单
	 */
	@Log( title = "合并订单", businessType = BusinessType.CLOSE )
	@GetMapping( value = "/fixOrder/{ids}" )
	public AjaxResult fixOrder( @PathVariable( "ids" ) String ids ) {
		String[] allId = ids.split( "," );
		return liveUserWithdrawNewlogService.fixOrder(allId );
	}
