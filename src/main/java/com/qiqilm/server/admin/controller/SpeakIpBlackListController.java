...
public class SpeakIpBlackListController extends BaseController {
	...
	@GetMapping( "/export" )
	public AjaxResult export(SpeakIpBlackList speakIpBlackList) {
		List<SpeakIpBlackList>      list = speakIpBlackListService.selectSpeakIpBlackListList(speakIpBlackList);
		ExcelUtil<SpeakIpBlackList> util = new ExcelUtil<>(SpeakIpBlackList.class);
		return util.exportExcel( list, "speakIpBlackList" );
	}
