...
/*
	 ...
	 * @return
	 */
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:resetPwd')" )
	 ...
	 * @return
	 */
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:addScore')" )
	...
	public Object addScore( HttpServletRequest request, ReqAddScore req ) throws Exception {
		...
		String username = loginUser.getUser().getUserName();
		rspBase = memberInfoService.addMemberMoneyOnly( ip, req.getId(), req.getScore(), req.getBeatNum(),
				req.getMk() + ",操作人:" + username,
	 ...
	 * @return
	 */
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:sendMsg')" )
	 ...
	 * @return
	 */
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:updateMobile')" )
...
/*        if (!ValidatorUtil.isNumber11(oldMobile)) {
	...
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:resetBox')" )
	...
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:resetTx')" )
	...
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:bcodeRepair')" )
	...
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:updateVip')" )
	...
	@PreAuthorize( "@ss.hasPermi('member:memberInfo:imBan')" )
