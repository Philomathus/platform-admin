...
import com.qiqilm.server.admin.annotation.Excels;
...
public class ExcelUtil<T> {
			...
			for ( int i = 1; i < rows; i++ ) {
				...
				for ( Map.Entry<Integer, Field> entry : fieldsMap.entrySet() ) {
					...
					if ( String.class == fieldType ) {
						...
						if ( StringUtils.endsWith( s, ".0" ) ) {
							...
							if ( StringUtils.isNotEmpty( dateFormat ) ) {
								val = com.qiqilm.server.admin.utils.DateUtils.parseDateToStr( dateFormat, ( Date ) val );
							} else {
						...
						if ( val instanceof String ) {
							val = com.qiqilm.server.admin.utils.DateUtils.parseDate( val );
					...
					if ( StringUtils.isNotNull( fieldType ) ) {
						...
						com.qiqilm.server.admin.utils.ReflectUtils.invokeSetter( entity, propertyName, val );
					}
				}
				list.add( entity );
			}
	...
	public void setCellVo( Object value, Excel attr, Cell cell ) {
		if ( Excel.ColumnType.STRING == attr.cellType() ) {
			...
			ClientAnchor anchor = new XSSFClientAnchor( 0, 0, 0, 0, ( short ) cell.getColumnIndex(), cell.getRow().getRowNum(),
					( short ) ( cell.getColumnIndex() + 1 ),
					cell.getRow().getRowNum() + 1 );
			String imagePath = Convert.toStr( value );
			if ( StringUtils.isNotEmpty( imagePath ) ) {
				byte[] data = com.qiqilm.server.admin.utils.ImageUtils.getImage( imagePath );
	...
	public int getImageType( byte[] value ) {
		String type = com.qiqilm.server.admin.utils.FileTypeUtils.getFileExtendName( value );
		...
		try {
			...
			if ( attr.isExport() ) {
				...
				if ( StringUtils.isNotEmpty( dateFormat ) && StringUtils.isNotNull( value ) ) {
					cell.setCellValue( com.qiqilm.server.admin.utils.DateUtils.parseDateToStr( dateFormat, ( Date ) value ) );
	...
	public String getAbsoluteFile( String filename ) {
		String downloadPath = Tv77Config.getDownloadPath() + filename;
