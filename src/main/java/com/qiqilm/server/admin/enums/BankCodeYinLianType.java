...
@Getter
public enum BankCodeYinLianType {
    ...
    BankCodeYinLianType( List<String> desc ) {
        this.desc = desc;
    }

    public static BankCodeYinLianType getCodeByDesc( String desc ) {
        for ( BankCodeYinLianType enumType : BankCodeYinLianType.values() ) {
