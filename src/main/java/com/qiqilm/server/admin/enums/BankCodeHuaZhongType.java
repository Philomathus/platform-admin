...
@Getter
public enum BankCodeHuaZhongType {
    //
    ...
    BankCodeHuaZhongType( List<String> desc ) {
        this.desc = desc;
    }

    public static BankCodeHuaZhongType getCodeByDesc( String desc ) {
        for ( BankCodeHuaZhongType enumType : BankCodeHuaZhongType.values() ) {
