...
@Getter
public enum BankCodeShangYinType {
	//
	...
	BankCodeShangYinType( List<String> desc ) {
		this.desc = desc;
	}

	public static BankCodeShangYinType getCodeByDesc( String desc ) {
		for ( BankCodeShangYinType enumType : BankCodeShangYinType.values() ) {
