...
@Repository ( value = ConstantsPayAgent.XIAO_JIN_REN_PAY + "PayAgentProcessor" )
@Log4j2
public class XiaoJinRenPayAgentProcessor extends AbstractPayAgent {
    @Override
    ...
    public String callbackPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap, String realIp ) throws Exception {
        ...
        if ( signRes.equalsIgnoreCase( sign ) ) {
            ...
            String            status          = dataMap.getOrDefault( "code", "" ).toString();
            ...
            payAgentService.processOrderPay( withdrawLog, payAgentLog, requestMap.getOrDefault( "order_no", "" )
                            .toString(), payAgentPlatform, "1".equals( status ) );
            return "OK";
        }
        return "fail";
    }
