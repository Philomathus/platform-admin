...
@Repository( value = ConstantsPayAgent.CFB_PAY + "PayAgentProcessor" )
@Log4j2
public class CfbPayAgentProcessor extends AbstractPayAgent {
    ...
    public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
        ...
        params.put( "bookingAddress" , withdrawLog.getBankAccount() );
        params.put( "coinType", "CFB" );
        params.put( "callbackCurrencyCode", "CFB" );
