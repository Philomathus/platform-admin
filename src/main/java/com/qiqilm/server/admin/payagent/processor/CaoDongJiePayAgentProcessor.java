...
@Repository( value = ConstantsPayAgent.CAO_DONG_JIE_PAY + "PayAgentProcessor" )
@Log4j2
public class CaoDongJiePayAgentProcessor extends AbstractPayAgent {
    @Override
    public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
        ...
        dataMap.put( "reqTime", DateFormatUtils.formate( new Date(), DateFormatUtils.TIGHT_PATTERN_DATETIME ) );
