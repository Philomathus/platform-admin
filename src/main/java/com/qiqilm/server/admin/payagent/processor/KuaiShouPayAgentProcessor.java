...
@Repository( value = ConstantsPayAgent.KUAI_SHOU_PAY + "PayAgentProcessor" )
@Log4j2
public class KuaiShouPayAgentProcessor extends AbstractPayAgent {
    @Override
    ...
    public String callbackPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap, String realIp ) throws Exception {
        ...
        if ( signRes.equalsIgnoreCase( sign ) ) {
            ...
            payAgentService.processOrderPay( withdrawLog, payAgentLog, "", payAgentPlatform, "1".equals( refCode ) );
            return "OK";
        }
        return "fail";
    }
