...
import com.qiqilm.server.admin.enums.BankCodeKuBiType;
...
public class KuBiPayAgentProcessor extends AbstractPayAgent {
    ...
    public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
        ...
        dataMap.put( "payAmt", withdrawLog.getWithdrawMoney().setScale( 2, BigDecimal.ROUND_HALF_UP ).toString() );
        ...
        dataMap.put( "Ext", "" );
        dataMap.put( "notifyUrl", sysConfigCacheUtil.getConf( "payAgentNotifyUrl" ) + ConstantsPayAgent.KUBI_PAY );
    ...
    public String callbackPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap, String realIp ) throws Exception {
        ...
        if ( mySign.equalsIgnoreCase( sign ) ) {
            ...
            payAgentService.processOrderPay( withdrawLog, payAgentLog, orderid, payAgentPlatform, "1".equals( bankstate ) );
            return "SUCCESS";
        }
    ...
    public String queryOrderPay( PayAgentLog payAgentLog ) throws Exception {
        ...
        dataMap.put( "mchId", payAgentPlatform.getMerId() );
        dataMap.put( "mchOrderId", withdrawLog.getOrderNo() );
        dataMap.put( "clientTime", DateFormatUtils.formate( new Date(), DateFormatUtils.TIGHT_PATTERN_DATETIME ) );
