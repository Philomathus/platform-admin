...
@Repository( value = ConstantsPayAgent.JIEYOU_PAY + "PayAgentProcessor" )
@Log4j2
public class JieYouPayAgentProcessor extends AbstractPayAgent {
    ...
    public String queryOrderPay( PayAgentLog payAgentLog ) throws Exception {
        ...
        if ( !CollectionUtils.isEmpty( resultMap ) ) {
            ...
            if ( "0".equals( code ) ) {
                ...
                if ( "100".equals( withdrawOrderStatus ) || "0".equals( withdrawOrderStatus )
                        || "90".equals( withdrawOrderStatus ) || "-10".equals( withdrawOrderStatus ) ) {
