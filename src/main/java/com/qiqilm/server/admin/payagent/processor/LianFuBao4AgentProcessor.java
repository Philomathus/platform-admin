...
@Repository( value = ConstantsPayAgent.LIAN_FU_BAO4 + "PayAgentProcessor" )
@Log4j2
public class LianFuBao4AgentProcessor extends AbstractPayAgent {
    @Override
    public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
        ...
        bodyMap.put( "notifyUrl", sysConfigCacheUtil.getConf( "payAgentNotifyUrl" ) + ConstantsPayAgent.LIAN_FU_BAO4 );
    ...
    public String callbackPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap, String realIp ) throws Exception {
        ...
        log.info(payAgentPlatform.getName()+"回调签名字符串:" + sign + "_" + signTwo);
        if ( sign.equalsIgnoreCase( signTwo) ) {
            if ( orderState > 0 ) {
    ...
    public Map<String, Object> reverseCheckOrderPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap,
        ...
        log.info(payAgentPlatform.getName()+"反查签名字符串:" + sign + "_" + mySign);
