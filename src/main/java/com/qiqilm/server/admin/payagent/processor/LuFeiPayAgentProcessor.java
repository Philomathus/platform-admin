...
public class LuFeiPayAgentProcessor extends AbstractPayAgent {
    ...
    public boolean orderPay(MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent) throws Exception {
        ...
        bodyMap.put("notify_url", sysConfigCacheUtil.getConf("payAgentNotifyUrl") + ConstantsPayAgent.LU_FEI);
        ...
        log.info(ConstantsPayAgent.LU_FEI+"代付下单结果 - result:{}", JsonUtil.object2Json(resultMap));
