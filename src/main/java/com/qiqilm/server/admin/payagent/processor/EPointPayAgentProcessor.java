...
@Repository( value = ConstantsPayAgent.EPOINT_PAY + "PayAgentProcessor" )
@Log4j2
public class EPointPayAgentProcessor extends AbstractPayAgent {
    @Override
    public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
        ...
        bodyMap.put( "notifyUrl", sysConfigCacheUtil.getConf( "payAgentNotifyUrl" ) + ConstantsPayAgent.EPOINT_PAY );
                ...
                if ( "0".equals( return_code ) ) {
                    ...
                    if ( "100".equals( trade_state ) || "0".equals( trade_state ) || "90".equals( trade_state )
                        ...
                        if ( "100".equals( trade_state ) ) {
                            status      = 6;
                            orderStatus = 1;
                        } else if ( "90".equals( trade_state ) || "-10".equals( trade_state ) ) { //将-10处理为90
                            status      = 5;
                            orderStatus = 2;
                        }
