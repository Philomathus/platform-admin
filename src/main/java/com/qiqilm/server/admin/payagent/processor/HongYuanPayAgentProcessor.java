...
@Repository ( value = ConstantsPayAgent.HONG_YUAN_PAY + "PayAgentProcessor" )
@Log4j2
public class HongYuanPayAgentProcessor extends AbstractPayAgent {
    @Override
    ...
    public String callbackPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap, String realIp ) throws Exception {
        ...
        if ( signRes.equalsIgnoreCase( sign ) ) {
            ...
            String            status          = dataMap.getOrDefault( "refCode", "" ).toString();
