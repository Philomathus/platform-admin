...
@Repository( value = ConstantsPayAgent.SHUNTONG2 + "PayAgentProcessor" )
@Log4j2
public class ShunTong2PayAgentProcessor extends AbstractPayAgent {
	@Override
	public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
		...
		try {
			...
			reqPayAgent.setFailReason("福财运2代付下单报错原因:" + e);
		}
		log.info( "福财运2代付下单结果- result:{}", JsonUtil.object2Json(resultMap) );
		...
		log.warn("福财运2代付订单提交失败 - orderNo:{}", withdrawLog.getOrderNo());
		return false;
	}
	...
	public String callbackPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap, String realIp ) throws Exception {
		...
		log.info( "福财运2代付回调签名:" + tempStr + "_" + sign );
