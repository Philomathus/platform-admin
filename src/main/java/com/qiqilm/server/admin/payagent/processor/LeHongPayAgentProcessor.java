...
@Repository( value = ConstantsPayAgent.LE_HONG_PAY + "PayAgentProcessor" )
@Log4j2
public class LeHongPayAgentProcessor extends AbstractPayAgent {
    @Override
    public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
        ...
        dataMap.put( "card_address", StringUtils.isBlank( withdrawLog.getBankAddress() ) ? "" : withdrawLog
                .getBankAddress()
                .trim() );
