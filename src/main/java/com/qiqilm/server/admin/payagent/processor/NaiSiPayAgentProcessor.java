...
@Repository( value = ConstantsPayAgent.NAISI_PAY + "PayAgentProcessor" )
@Log4j2
public class NaiSiPayAgentProcessor extends AbstractPayAgent {
    @Override
    ...
    public String callbackPay( PayAgentPlatform payAgentPlatform, Map<String, Object> requestMap, String realIp ) throws Exception {
        ...
        if ( signRes.equalsIgnoreCase( sign ) ) {
            ...
            payAgentService.processOrderPay( withdrawLog, payAgentLog, requestMap
                    .getOrDefault( "transaction_id", "" )
                    .toString(), payAgentPlatform, "1".equals( refCode ) );
            return "OK";
        }
        return "fail";
    }
