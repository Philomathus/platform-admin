...
import com.qiqilm.server.admin.enums.BankCodeMyType;
...
@Repository ( value = ConstantsPayAgent.MY_PAY + "PayAgentProcessor" )
@Log4j2
public class MyPayAgentProcessor extends AbstractPayAgent {

    @Override
    public boolean orderPay( MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent ) throws Exception {
        BankCodeMyType bankCodeType = BankCodeMyType.getCodeByDesc( withdrawLog.getBankName() );
        ...
        Map<String, Object> resultMap = this.sendPostMap( payAgentPlatform.getPayOrderAddr(), packageJson( dataMap ), reqPayAgent );
    ...
    public String queryOrderPay( PayAgentLog payAgentLog ) throws Exception {
        ...
        dataMap.put( "version", "1.0.0" );
        dataMap.put( "merchantOrderNo", withdrawLog.getOrderNo() );
        dataMap.put( "submitTime", DateFormatUtils.formate( new Date(), DateFormatUtils.TIGHT_PATTERN_DATETIME ) );
