...
@Repository( value = ConstantsPayAgent.SHUN_WEI5 + "PayAgentProcessor" )
@Log4j2
public class ShunWei5PayAgentProcessor extends AbstractPayAgent {
    @Override
