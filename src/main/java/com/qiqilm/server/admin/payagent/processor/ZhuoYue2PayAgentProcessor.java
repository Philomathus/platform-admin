...
@Repository(value = ConstantsPayAgent.ZHUO_YUE2 + "PayAgentProcessor")
@Log4j2
public class ZhuoYue2PayAgentProcessor extends AbstractPayAgent {
    @Override
    public boolean orderPay(MemberWithdrawLog withdrawLog, PayAgentPlatform payAgentPlatform, ReqPayAgent reqPayAgent) throws Exception {
        ...
        bodyMap.put("NotifyUrl", sysConfigCacheUtil.getConf("payAgentNotifyUrl") + ConstantsPayAgent.ZHUO_YUE2);
