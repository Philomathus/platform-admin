...
public interface ILogService {
	...
	void logmarkMoneyPaiSong( String userid, String username, EnumMoney enumTrans, BigDecimal totalNow, BigDecimal totalold,
							 String des, String mark, String ordermk );
